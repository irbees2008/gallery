...
class PluginGallery
{
    ...
    public function indexPageAction($params)
    {
        ...
        if ($this->params['if_description'] and !empty($this->params['seo_description'])) $SYSTEM_FLAGS['meta']['description'] = $this->params['seo_description'];
        if ($this->params['if_keywords'] and !empty($this->params['seo_keywords'])) $SYSTEM_FLAGS['meta']['keywords'] = $this->params['seo_keywords'];
    ...
    public function galleryPageAction($params)
    {
        ...
        $SYSTEM_FLAGS['info']['title']['item'] = __('gallery:page').' ' . $page;
        if ($this->params['if_description']) $SYSTEM_FLAGS['meta']['description'] = $gallery['description'];
        if ($this->params['if_keywords']) $SYSTEM_FLAGS['meta']['keywords'] = $gallery['keywords'];
    ...
    public function imagePageAction($params)
    {
        ...
        if ($this->params['if_description']) $SYSTEM_FLAGS['meta']['description'] = $row['description'];
