...
class PluginGallery
{
    ...
    {
        $this->params = pluginGetVariable('gallery');
    }
    ...
    public function categoryAction()
    {
        ...
        if ($this->params['cache']) {
            ...
            $cacheData = cacheRetrieveFile($cacheFileName, $this->params['cache_expire'], 'gallery');
            if ($cacheData != false) {
                return $template['vars']['plugin_gallery_category'] = $cacheData;
            }
        }

        $tPath = plugin_locateTemplates('gallery', ['category']);
        $tVars = [
    ...
    public function widgetAction()
    {
        ...
        foreach ($widgets as $id => $widget) {
            ...
            $tpath = plugin_locateTemplates('gallery', ['widget'], $widget['skin']);
            $tVars = [
    ...
    public function indexPageAction($params)
    {
        ...
        $tpath = plugin_locateTemplates('gallery', ['page_index']);
        $tVars = [
            'plugin_title' => $this->pluginTitle,
    ...
    public function galleryPageAction($params)
    {
        ...
        $tpath = plugin_locateTemplates('gallery', ['page_gallery'], $gallery['skin']);
        $tVars = [
            'plugin_title' => $this->pluginTitle,
    ...
    public function imagePageAction($params)
    {
        ...
        if ($cPlugin->isActive('comments')) {
            ...
            $tPath = plugin_locateTemplates('comments', ['comments.internal']);
        ...
        $tpath = plugin_locateTemplates('gallery', ['page_image'], $gallery['skin']);
        $tVars = [
            'plugin_title' => $this->pluginTitle,
...
register_plugin_page('gallery', '', [$gallery, 'indexPageAction']);
register_plugin_page('gallery', 'gallery', [$gallery, 'galleryPageAction']);
register_plugin_page('gallery', 'image', [$gallery, 'imagePageAction']);
